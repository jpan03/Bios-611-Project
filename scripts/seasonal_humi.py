...
plt.plot(winter2['Humidity____'],winter2['PM_2_5_10_Minute_Avg_'],label='winter')
plt.plot(spring2['Humidity____'],spring2['PM_2_5_10_Minute_Avg_'],label='spring')
plt.plot(summer2['Humidity____'],summer2['PM_2_5_10_Minute_Avg_'],label='summer')
plt.plot(autumn2['Humidity____'],autumn2['PM_2_5_10_Minute_Avg_'],label='autumn')
plt.legend()
plt.xlabel('Humidity____')
plt.ylabel('pm2.5_10')
plt.savefig("seasonal_humi.png",bbox_inches="tight")
