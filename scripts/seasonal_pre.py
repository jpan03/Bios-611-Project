...
plt.plot(winter2['Pressure__mbar_'],winter2['PM_2_5_10_Minute_Avg_'],label='winter')
plt.plot(spring2['Pressure__mbar_'],spring2['PM_2_5_10_Minute_Avg_'],label='spring')
plt.plot(summer2['Pressure__mbar_'],summer2['PM_2_5_10_Minute_Avg_'],label='summer')
plt.plot(autumn2['Pressure__mbar_'],autumn2['PM_2_5_10_Minute_Avg_'],label='autumn')
plt.legend()
plt.xlabel('Pressure__mbar_')
plt.ylabel('pm2.5_10')
plt.savefig("seasonal_pre.png",bbox_inches="tight")
